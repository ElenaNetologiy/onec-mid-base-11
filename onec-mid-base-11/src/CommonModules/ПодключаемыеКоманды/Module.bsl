...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	//Начало net_Балабкина Е.А. 18.10.2025г.Задача1 Программное добавление реквизита "Контактное лицо" в формы, где есть реквизт "Договор"
	Net_РаботаСФормами.ДополнитьФорму(Форма)
	//Конец net_Балабкина Е.А. 18.10.2025г.Задача1
